...
#include "../include/SurfaceNormal.h"
...
int main()
{
	...
	while (1){// (!plot3d.wasStopped()){
		cout << cntFrame << ", ";
                // Read names of the Images from the File Folders
		...
		applyColorMap(imgDisp8, imgDispColor, COLORMAP_OCEAN);
                ...
                // -----------ESTIMATION OF DYNAMIC STIXELS X-Y ------------------
